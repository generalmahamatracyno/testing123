...
if S=="choose":
    ...
    st.subheader("Abandoned Temple")
    pic("Temple")

    a, b = st.columns(2)

    if a.button(
        "Search trail: −2 stamina, +2 coins",
        use_container_width=True
    ):
        spend_stamina(2)
    ...
    if b.button(
        ...
        if st.session_state.coins >= 2:
            ...
            st.session_state.message = "You need 2 coins."
